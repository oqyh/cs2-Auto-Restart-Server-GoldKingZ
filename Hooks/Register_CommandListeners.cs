...
public partial class MainPlugin
{
    public void Register_CommandListeners()
    {
        ...
        Helper.RegisterCssCommands(Configs.Instance.Reload_Plugin.Reload_Plugin_CommandsInGame.ConvertCommands(), "Commands To Reload Auto Restart Server Plugin", CommandsAction_ReloadPlugin);
    }
